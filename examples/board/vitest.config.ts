...
export default defineConfig({
  resolve: {
    alias: {
      "@webmcp-bridge/agent-browser-core": new URL(
        "../../packages/agent-browser-core/src/index.ts",
        import.meta.url,
      ).pathname,
      "@webmcp-bridge/adapter-utils": new URL("../../packages/adapter-utils/src/index.ts", import.meta.url).pathname,
