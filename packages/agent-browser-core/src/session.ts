 ...
 * It depends on adapter manifest types and Node process/filesystem APIs so agent-browser-core can manage reusable browser sessions without MCP transport concerns.
 */
